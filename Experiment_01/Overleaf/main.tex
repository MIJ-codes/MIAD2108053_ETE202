...
\usepackage[margin=1in, left=1.5in, top=1.2in, includefoot]{geometry} % is used to marginalize the document
...
\begin{document}
        ...
        \vspace{20pt}
            \begin{figure}[h]
                ...
                \begin{subfigure}[h]{0.4\textwidth} %npn pointed
                    \includegraphics[width=\textwidth, height = 1.4in]{ETE202Experiment01Figures/2N3904pinout.png}
                ...
                \centering
                    \includegraphics[width=0.7\textwidth, height = 1.4in]{ETE202Experiment01Figures/2N3904.png}
                    \caption{2N3904 n-p-n transistor of electronics lab.}
                    \label{fig:subfig2}
                \end{subfigure}
                \vspace{20pt} 
                \begin{subfigure}[h]{0.4\textwidth} %pnp pointed
                    \includegraphics[width = \textwidth, height = 1.9in]{ETE202Experiment01Figures/2N3906pinout.png}
                    \caption{2N3906 p-n-p transistor with Emitter, Base, Collector pointed.}
                    \label{fig:subfig3}
                \end{subfigure}
                \hfill
                \begin{subfigure}[h]{0.4\textwidth} %pnp lab
                    \includegraphics[width = \textwidth, height = 1.9in]{ETE202Experiment01Figures/2N3906.png}
        ...
        \subsection{Transistor voltage analysis:}
            \begin{figure}[h]
                ...
                \begin{subfigure}[h]{0.4\textwidth} %npn eb voltage
                    \includegraphics[width=\textwidth, height = 5cm]{ETE202Experiment01Figures/2N3904Volatage01.png}
                ...
                \centering
                    \includegraphics[width=0.6\textwidth, height = 5cm]{ETE202Experiment01Figures/2N3904Volatage02.png}
                ...
                \begin{subfigure}[h]{0.4\textwidth} %pnp eb voltage
                    \centering
                    \includegraphics[width = 0.7\textwidth, height = 5cm]{ETE202Experiment01Figures/2N3906voltage01.png}
                    \caption{Emitter-Base voltage of p-n-p transistor.}
                    \label{fig:subfig7}
                \end{subfigure}
                \hfill
                \begin{subfigure}[h]{0.4\textwidth} %pnp cb voltage
                    \includegraphics[width = \textwidth, height = 5cm]{ETE202Experiment01Figures/2N3906voltage02.png}
    ...
    \newpage
        ...
        \subsection{Resistor analysis:}
            \begin{figure}[h]
            \centering
                \includegraphics[width= \textwidth]{ETE202Experiment01Figures/Resistor_color_codes.png}
            ...
            \centering
                ...
                \centering
                    \includegraphics[width=\textwidth, height = 4cm]{ETE202Experiment01Figures/120ohmbrownredbrown.png}
                ...
                \begin{subfigure}[H]{0.3\textwidth}
                \centering
                    \includegraphics[width = 1\textwidth, height = 4cm]{ETE202Experiment01Figures/120ohmcodebrownredbrown.png}
                ...
                \begin{subfigure}[H]{0.3\textwidth}
                \centering
                    \includegraphics[width=0.7\textwidth, height = 4cm]{ETE202Experiment01Figures/120ohmtestbrownredbrown.png}
            ...
            \centering
                \begin{subfigure}[h]{0.3\textwidth}
                \centering
                    \includegraphics[width=\textwidth, height = 4cm]{ETE202Experiment01Figures/470ohmyellowvioletbrown.png}
                ...
                \begin{subfigure}[H]{0.3\textwidth}
                \centering
                    \includegraphics[width = 1\textwidth, height = 4cm]{ETE202Experiment01Figures/470ohmcodeyellowvioletbrown.png}
                ...
                \begin{subfigure}[h]{0.3\textwidth}
                \centering
                    \includegraphics[width=0.7\textwidth, height = 4cm]{ETE202Experiment01Figures/470ohmtestyellowvioletbrown.png}
            ...
            \centering
                \begin{subfigure}[h]{0.3\textwidth}
                \centering
                    \includegraphics[width=\textwidth, height = 4cm]{ETE202Experiment01Figures/560ohmgreenbluebrown.png}
                ...
                \begin{subfigure}[H]{0.3\textwidth}
                \centering
                    \includegraphics[width = 1\textwidth, height = 4cm]{ETE202Experiment01Figures/560ohmcodegreenbluebrown.png}
                ...
                \begin{subfigure}[h]{0.3\textwidth}
                \centering
                    \includegraphics[width=0.7\textwidth, height = 4cm]{ETE202Experiment01Figures/560ohmtestgreenbluebrown.png}
